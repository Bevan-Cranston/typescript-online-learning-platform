...
This was because the compiler couldn’t rule out that elements in nameOfNames or coursesList would be undefined so we had to explicitly account for this and force typescript to assume the variable is defined. 
